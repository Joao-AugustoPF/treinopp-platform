...
import type { IUnidadeHistorico } from '../types';
...
type Props = {
  ...
  updatedAt: string;
  updatedBy: string;
  historico: IUnidadeHistorico[];
};

export function UnidadeProfileHistory({
  createdAt,
  createdBy,
  updatedAt,
  updatedBy,
  ...
  const renderHistorico = () => (
    <Card>
      <CardHeader title="Histórico da Unidade" />
            ...
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Box>
                ...
                <Box sx={{ typography: 'caption', color: 'text.secondary' }}>
                  Unidade: {item.UnidadeNome ?? item.UnidadeId}
                </Box>
              </Box>
