...
export const _mock = {
  ...
  zipCode: (index: number) => `0000${index}-000`, // ou algum valor mockado realista
  city: (index: number) =>
    ['São Paulo', 'Rio de Janeiro', 'Curitiba', 'Recife', 'Porto Alegre'][index % 5],
  state: (index: number) => ['SP', 'RJ', 'PR', 'PE', 'RS'][index % 5],
};
